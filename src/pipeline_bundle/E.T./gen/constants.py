...
# paths to layouts
LAYOUTS_PATH = os.path.join(os.environ['ET_ROOT'], 'gen/layouts')
FF_PATH = os.path.join(os.environ['ET_ROOT'], 'gen/ff_planner/ff')
PLANNER_PATH = os.path.join(os.environ['ET_ROOT'], 'gen/planner')
